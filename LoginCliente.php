...
<html lang = "en">
    ...
    <head>
      ...
      <script>
         function set(){
            document.getElementById("textEmail").value = "victorperes2000@gmail.com";
            document.getElementById("textSenha").value = "Senha1!";
         }
         function loginPsicologo(bodyData) {
            const url = 'https://limitless-escarpment-62515.herokuapp.com/api/patient/login';
            ...
            .then(
               ...
               .then(data => {location.href = 'AlterarCliente.php?id='+data.id})
