        ...
        <nav class="nav">
            ...
            <a class="nav-link disabled" href="#">
                <div class="d-flex w-100 justify-content-between">
                    <h5 class="mb-1">Victor Fernandes</h5>
                </div>
                <p class="mb-1">Psicologo Infantil</p>
                <small>CRP - SP</small>
            </a>
        </nav>
            ...
            <div class="overflow-auto CampoMensagens">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action list-group-item-secondary text-end">
                        <div class="d-flex w-100 justify-content-between">
